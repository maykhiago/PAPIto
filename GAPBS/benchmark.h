...
#include "papito.h" //Hiago MGA Rocha (24/05/2021)
...
void BenchmarkKernel(const CLApp &cli, const GraphT_ &g,
  ...
  papito_init(); //Hiago MGA Rocha (24/05/2021)
  ...
  for (int iter=0; iter < cli.num_trials(); iter++)
  {
    ...
    printf("\n");
    papito_start(); //Hiago MGA Rocha (24/05/2021)
    auto result = kernel(g);
    papito_end(); //Hiago MGA Rocha (24/05/2021)
